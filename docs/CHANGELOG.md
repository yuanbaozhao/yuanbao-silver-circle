...
### 研究报告栏目 V1
- 新增 `reports.html`，上线首批 12 份银发经济与养老产业第三方研究报告索引。
- 报告按产业全景、银发消费、养老金融、智慧养老、政策与人口分类，可在页面内筛选并展开目录。
- 页面只展示报告元数据、原创导读和目录索引，不公开第三方 PDF 正文及下载地址。
- 新增联系获取详情入口，并接入共享导航、页脚和站点地图。
